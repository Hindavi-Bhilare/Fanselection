...
import com.velotech.fanselection.offer.service.OfferPumpSpecificationService;
import com.velotech.fanselection.utils.ApplicationResponse;
import com.velotech.fanselection.utils.RequestWrapper;

@RestController
@RequestMapping(value = "/offer/specification")
public class OfferPumpSpecificationController {

	static String serviceName = "OfferPumpSpecification";

	@Autowired
	private OfferPumpSpecificationService service;
