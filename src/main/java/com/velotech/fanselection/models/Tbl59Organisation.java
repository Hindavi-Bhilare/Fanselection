...
/**
 * Tbl59Organisation generated by hbm2java
 */
@Entity
@Table(name = "tbl_59_organisation")
...
public class Tbl59Organisation implements java.io.Serializable {
	...
	public Tbl59Organisation() {
	}

	public Tbl59Organisation(int id) {
		this.id = id;
	}
	...
	@Column(name = "organisationCode", length = 50)
	...
	@Column(name = "organisationDetails", length = 50)
