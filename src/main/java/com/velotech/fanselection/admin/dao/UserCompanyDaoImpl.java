...
@Repository
public class UserCompanyDaoImpl extends HibernateSession implements UserCompanyDao {

	static Logger log = LogManager.getLogger(UserCompanyDaoImpl.class.getName());
