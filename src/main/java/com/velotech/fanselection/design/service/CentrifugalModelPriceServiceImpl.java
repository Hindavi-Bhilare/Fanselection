...
@Service
@Transactional
public class CentrifugalModelPriceServiceImpl implements MasterService {

	static Logger log = LogManager.getLogger(CentrifugalModelPriceServiceImpl.class.getName());
	...
	public void downloadExcel(RequestWrapper requestWrapper) {
		...
		try {
			...
			criterias.add(new SearchCriteria("tbl01CentrifugalModelMaster.id", requestWrapper.getParentId()));
