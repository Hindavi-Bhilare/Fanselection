...
import com.velotech.fanselection.design.service.MotorTypeService;
...
@RestController
@RequestMapping(value = "/design/motortype")
public class MotorTypeController {

	static String serviceName = "MotorType";
	...
	@RequestMapping(value = "/getMotorTypeTree", method = RequestMethod.GET)
	public Object getMotorTypeTree(RequestWrapper requestWrapper){
		return motorTypeService.getMotorTypeTree(requestWrapper);
