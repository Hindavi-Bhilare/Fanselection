...
import com.velotech.fanselection.design.service.GenericBomService;
...
@RestController
@RequestMapping(value = "/design/genericbom")
public class GenericBomController {

	static String serviceName = "GenericBom";

	@Autowired
	private MasterSericeUtil serviceUtil;

	@Autowired
	private GenericBomService service;
	...
	@RequestMapping(value = "/copygenericbom", method = RequestMethod.POST)
	public ApplicationResponse copygenericbom(@RequestParam Integer genericBomId) throws JsonParseException, JsonMappingException, IOException {

		return service.copygenericbom(genericBomId);
	}
