...
public class XYSmoothLineAndShapeRenderer extends XYLineAndShapeRenderer {
	 ...
	 */
	@Override
	protected void drawPrimaryLine(XYItemRendererState state, Graphics2D g2, XYPlot plot, XYDataset dataset, int pass, int series, int item,
		...
		int steps = ((int) (Math.abs((point2.x - point1.x)) / 0.2) < 30) ? (int) (Math.abs((point2.x - point1.x)) / 0.2) : 30;

		Point2D.Double[] points = getBezierCurve(point0, point1, point2, point3, 2, steps);
	 ...
	 * @param smooth
	 */
	public static void getControlPoints(Point2D.Double point0, Point2D.Double point1, Point2D.Double point2, Point2D.Double point3,
			Point2D.Double control1, Point2D.Double control2, double smooth) {
	 ...
	 */
	public static Point2D.Double[] getBezierCurve(Point2D.Double point0, Point2D.Double point1, Point2D.Double point2, Point2D.Double point3,
			double smooth, int steps) {
