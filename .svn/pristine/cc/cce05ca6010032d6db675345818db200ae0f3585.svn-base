...
@RestController
@RequestMapping(value = "/admin/usertypeselectiontype")
public class UsertypeSelectiontypeMasterController {

	static String serviceName = "UsertypeSelectiontypeMaster";
