...
/**
 * Tbl90XmlModelmaster generated by hbm2java
 */
@Entity
@Table(name = "tbl_90_xml_modelmaster")
...
public class Tbl90XmlModelmaster implements java.io.Serializable {
	...
	public Tbl90XmlModelmaster() {
	}

	public Tbl90XmlModelmaster(Integer id) {
		this.id = id;
	}
	...
	@Column(name = "fanModel", length = 50)
