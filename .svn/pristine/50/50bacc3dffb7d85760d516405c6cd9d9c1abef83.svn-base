...
import com.velotech.fanselection.design.service.MocMasterService;
...
@RestController
@RequestMapping(value = "/design/mocmaster")
public class MocMasterController {

	static String serviceName = "MocMaster";

	@Autowired
	private MasterSericeUtil serviceUtil;
	
	@Autowired
	private MocMasterService service;
	...
	public ApplicationResponse addRecords(@RequestBody String requestPayload) throws JsonParseException, JsonMappingException, IOException {

			return service.addRecords(requestPayload);
	}
