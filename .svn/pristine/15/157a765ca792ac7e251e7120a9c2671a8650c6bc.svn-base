...
@Repository
public class CentrifugalModelPriceDaoImpl extends HibernateSession implements CentrifugalModelPriceDao {
	...
	public ApplicationResponse getModelPriceData(RequestWrapper requestWrapper) {
		...
		try {
			...
			criteria.add(Subqueries.propertyIn("tbl01CentrifugalModelMaster.id", detachedCriteria));
